...
This issue will be adressed later on.
\begin{figure}[h!]
  \centering
...
\noindent
Further we explore the parallelism of the algorithm using \textit{Amdahls} law.
\red{\ldots}
...
We expect a power law behavior below the critical temperature, exponential above and 
long range order at the transition point. The correlation functions for 
\red{\ldots}
